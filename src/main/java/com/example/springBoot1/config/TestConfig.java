...
import com.example.springBoot1.entities.Payment;
...
import com.example.springBoot1.repositories.CategoryRepository;
import com.example.springBoot1.repositories.OrderItemRepository;
import com.example.springBoot1.repositories.OrderRepository;
...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		categoryRepository.saveAll(Arrays.asList(cat1, cat2, cat3));  // save to database
		...
		productRepository.saveAll(Arrays.asList(p1, p2, p3, p4, p5));  // save to database
